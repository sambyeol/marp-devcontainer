...
target "alpine" {
    ...
    tags = [
        "ghcr.io/sambyeol/marp-devcontainer:3.4.0-alpine",
        "ghcr.io/sambyeol/marp-devcontainer:3.4-alpine",
        "ghcr.io/sambyeol/marp-devcontainer:3-alpine",
        "ghcr.io/sambyeol/marp-devcontainer:alpine",

        "ghcr.io/sambyeol/marp-devcontainer:3.4.0",
        "ghcr.io/sambyeol/marp-devcontainer:3.4",
...
target "debian" {
    ...
    tags = [
        "ghcr.io/sambyeol/marp-devcontainer:3.4.0-debian",
        "ghcr.io/sambyeol/marp-devcontainer:3.4-debian",
