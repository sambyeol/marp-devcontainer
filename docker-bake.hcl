...
target "alpine" {
    ...
    tags = [
        "ghcr.io/sambyeol/marp-devcontainer:3.2.0-alpine",
        "ghcr.io/sambyeol/marp-devcontainer:3.2-alpine",
        "ghcr.io/sambyeol/marp-devcontainer:3-alpine",
        "ghcr.io/sambyeol/marp-devcontainer:alpine",

        "ghcr.io/sambyeol/marp-devcontainer:3.2.0",
        "ghcr.io/sambyeol/marp-devcontainer:3.2",
...
target "debian" {
    ...
    tags = [
        "ghcr.io/sambyeol/marp-devcontainer:3.2.0-debian",
        "ghcr.io/sambyeol/marp-devcontainer:3.2-debian",
